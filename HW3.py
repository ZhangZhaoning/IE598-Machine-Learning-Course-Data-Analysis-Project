...
Attribute2 = rocksVMines.iloc[:,1]
Attribute3 = rocksVMines.iloc[:,2]

plot.scatter(Attribute2, Attribute3)
plot.xlabel("2nd Attribute")
plot.ylabel(("3rd Attribute"))
plot.show()

Attribute21 = rocksVMines.iloc[:,20]
plot.scatter(Attribute2, Attribute21)
plot.xlabel("2nd Attribute")
...
print("My name is Zhaoning Zhang")
